<%@ Page Title="Inscrire" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="WebAchats2.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <main aria-labelledby="title">
        ...
        <div class="row">
            <asp:Label runat="server" AssociatedControlID="Societe" CssClass="col-md-2 col-form-label">Societé</asp:Label>
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="Societe" CssClass="form-control" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="Societe"
                    CssClass="text-danger" ErrorMessage="Le champ societé obligatoire." />
            </div>
        </div>
